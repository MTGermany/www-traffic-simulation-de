...
public interface Constants{ // MicroApplet3_0
    ...
    static final double BIAS_RIGHT_CAR = 0.0; // right-lane bias  
    static final double BIAS_RIGHT_TRUCK = 0.5; 
    static final double BIAS_RIGHT_CAR3 = 0.1; // right-lane bias  
    static final double BIAS_RIGHT_TRUCK3 = 5; 
    static final double P_FACTOR_CAR = 0.2;   // politeness factor
    static final double P_FACTOR_TRUCK = 0.2; 
    static final double DB_CAR = 0.1;   // changing thresholds (m/s^2)
    static final double DB_TRUCK = 0.2; 
    static final double DB_CAR3 = 0.3; // 0.3;  
    static final double DB_TRUCK3 = 0.2; // 0.2;
    ...
    static final int DENS_INIT_INVKM = 20;    //
