...
public class MicroStreet implements Constants{
  ...
  static final int RIGHT=1; 
    ...
    static final Color colorTruck=new Color(80,80,85);
    static final Color colorPerturb=new Color(255,160,160); 
    // color  of probeveh in VehicleImage2D.java
...
// but not during application of this function from further above
      ...
      System.out.println("MicroStreet.applyLocalPert at veh "+i+" imax="+imax);
    }
...
*/
	...
	//System.out.println("MicroStreet.accelerate: imax="+imax);
